...
namespace ALMA_API.Utils
{
    ...
    {
        private const string RandomCharset = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
        ...
        public static string GenerateTemporaryPassword()
        {
            ...
            for (var i = 0; i < 10; i++)
            {
                builder.Append(RandomCharset[new Random().Next(RandomCharset.Length)]);
            }
